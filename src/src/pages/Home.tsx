	...
	return (
		<div className='flex justify-center pt-10 px-5 mx-auto w-full h-full'>
			...
			<div className='relative w-[560px] h-full'>
				...
				/>
				{dropDown && (
					<ul className='list-none absolute top-[70px] left-0 right-0 max-h-500 overflow-y-scroll bg-slate-900 shadow-md text-gray-500 rounded-md p-4'>
				...
				{!dropDown && data && (
					<div className='min-h-[300px] max-h-500 overflow-y-scroll'>
						{repos?.map(repo => (
